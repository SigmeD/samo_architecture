...
export const homeworkReview: ModuleSpec = {
  ...
  process: {
    ...
    steps: [
      { n: 1, title: "Очередь", desc: "Список ДЗ по группам с фильтрами: ожидают / на доработке / приняты, с периодами.", source: "SPEC-DNM-TZ-001 v3.5 §4.4" },
      { n: 2, title: "Просмотр работы", desc: "Текст/файл/фото; видны затруднения ученика. Статусы PENDING → SUBMITTED → IN_REVIEW.", source: "SPEC-M3-DNM-001 v2.3" },
      ...
      { n: 4, title: "Решение", desc: "«Принять» (ACCEPTED) или «На доработку» (REVISION) — комментарий обязателен. Баллов нет.", source: "SPEC-DNM-TZ-001 v3.5 §4.4" },
  ...
  sources: [{ id: "SPEC-DNM-TZ-001", version: "3.5", section: "4.4" }, { id: "SPEC-M3-DNM-001", version: "2.3" }, { id: "REG-DNM-CURATOR-001", version: "1.0" }, { id: "REG-DNM-SOLARS-001", version: "1.0" }],
};
