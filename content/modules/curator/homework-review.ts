...
export const homeworkReview: ModuleSpec = {
  ...
  sources: [{ id: "SPEC-DNM-TZ-001", version: "3.8", section: "4.4" }, { id: "SPEC-M3-DNM-001", version: "2.7" }, { id: "REG-DNM-CURATOR-001", version: "1.0" }, { id: "REG-DNM-SOLARS-001", version: "1.0" }],
};
