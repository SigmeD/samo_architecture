...
- [ ] **Step 1:** В `docs/STATUS.md` (rollout-секция) — отметить finance done (источники, инварианты, открытые вопросы: ставка налога, фикс-ставки KPI, структура «Отчёт», финмодель финансиста, Само 24).
...
Ставка налога (упрощёнка/ИПН); фикс-ставки и планы KPI (руководитель франшизы, SPEC-KPI-PAYOUT-001 §5); структура вкладки «Отчёт» (финансист/руководитель франшизы); реализованная финмодель/калькулятор роялти финансиста (OQ-001, discovery до ADR-0002); 1С-интеграция; Само 24 (ADR-0002 Proposed, гейт G0 — сейчас бухгалтерия видит лишь 30–40% оплат).
