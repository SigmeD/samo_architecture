...
export const curator: CabinetSpec = {
  ...
  coreProcess: {
    ...
    note: "Заменяет отменённый чек-лист «7 этапов» (намерение, финальный пакет передаёт руководитель франшизы). В каноне два кандидата структуры: 3-фазная (REG-DNM-LESSON-001) и 9-этапная методичка (REG-DNM-CURATOR-001).",
    steps: [
...
export const lessonJournal: ModuleSpec = {
  ...
  note: "На подтверждении у руководителя франшизы: финальный пакет процедуры. В каноне два кандидата структуры — 3-фазная (REG-DNM-LESSON-001) и 9-этапная методичка (REG-DNM-CURATOR-001).",
