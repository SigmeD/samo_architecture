...
счётчики (11 кабинетов / 73 модуля / 108 моделей / 4 семестра / языки ru-kz-tj-uz); ядро (тест ≥70%, солары, RBAC-scope, ИИ-аватар Довлатова); по кабинетам — денежные/нормативные (роялти 20%; выплаты Фикса+Бонус−Штраф; лимиты групп 5–8; наполнение 250/120; коэф. пробного 70–80%; «принято/не принято» без баллов; 3 пути регистрации; статусы договора активен/не активен/ждёт оплаты).
...
export const overview: OverviewSpec = {
  header: {
    ...
    lead: "Детская Бизнес Академия Саидмурода Давлатова · финансовая грамотность и предпринимательство · 10–17 лет.",
    meta: [
      ...
      cabinets: [
        { slug: "child", emoji: "🎓", name: "Кабинет ученика", roleCaption: "ребёнок 10–17 лет · потребитель обучения", zone: "green", hero: true,
          highlights: [
            ...
            "ИИ-аватар Довлатова, «Зачем учиться» (топ-100)",
...
core: { emoji: "🧠", title: "Учебный движок · Аналитика и KPI · Геймификация", feats: [
  ...
  "ИИ-аватар Довлатова — у ученика, родителя, куратора",
] },
```
