...
**Текущая фаза.** v0 live (`samoarchitecture.vercel.app`), единая постер-стилистика L0+L1. **Наполнены 11 из 12 кабинетов** (Куратор/Ученик/Родитель/Финансист · Куратор франшиз/Франчайзи/Администратор школы/Старший куратор · **Руководитель проекта/Менеджер по продажам/Маркетолог** — 08.06); остался стаб **guest**. Добавлены: L0 **«Сводная карта системы»** (`/map`: иерархия + матрица RBAC + карта передач), механизм меток **New** (новизна vs постер, снимается при мердже), UX-редизайн читаемости (панель «Роль, границы и инварианты» внизу + контур-цикл). Расхождения с каноном — в `docs/canon-proposals/` (на согласовании клиента, не правим канон молча). Текущая работа — ветка **`update_08_06`**. План rollout: `docs/superpowers/plans/2026-06-06-cabinets-poster-rollout.md`.
...
- [ ] Кабинеты-стабы (rollout — следующие фазы): остался **guest** (онбординг до авторизации) (готовы: Куратор/Ученик/Родитель/Финансист/Куратор франшиз/Франчайзи/Администратор школы/Старший куратор/Руководитель проекта/Менеджер по продажам/**Маркетолог**)
