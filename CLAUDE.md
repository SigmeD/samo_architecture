...
- [x] **Наполнены 5 кабинетов** (канон через MCP + встречи + проектный док): Куратор (blue), Ученик (green), Родитель (blue), Финансист (gold), **Куратор франшиз (purple, 14 доменов — управление франшизами)**. Каждый — ядро-процесс, домены, связи, модули, `sources[]`
...
**Не сделано / блокеры:**
- [ ] Кабинеты, кроме Куратора/Ученика/Родителя/Финансиста/Куратора франшиз, — навигируемые стабы (rollout — следующие фазы)
