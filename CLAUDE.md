...
- [x] **Наполнены 6 кабинетов** (канон через MCP + встречи + проектный док): Куратор (blue), Ученик (green), Родитель (blue), Финансист (gold), **Куратор франшиз (purple, 14 доменов)**, **Франчайзи/директор (purple, 13 доменов — владелец сети; центр = деньги+планирование; 07.06, Workflow ultracode)**. Каждый — ядро-процесс, домены, связи, модули, `sources[]`
